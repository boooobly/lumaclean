...
export const serviceSeoContent: Record<Locale, Record<ServiceId, ServiceSeoContent>> = {
  ru: {
    regular: {
      slug: "uborka-kvartir",
      title: "Уборка квартир в Белграде — цены от 4 100 RSD | LumaClean",
      description: "Поддерживающая уборка квартир по всему Белграду: комнаты, кухня, санузел и полы. Цена от 4 100 RSD, расчёт до выезда.",
      ...
      faq: [
        {q: "Сколько стоит уборка квартиры в Белграде?", a: "Поддерживающая уборка стоит от 4 100 RSD. Точный ориентир зависит от площади, состояния квартиры и дополнительных работ."},
        ...
        {q: "Входит ли мойка окон?", a: "Окна добавляются отдельно: стандартное окно — 950 RSD, большое или панорамное — от 1 300 RSD."},
    ...
    deep: {
      ...
      title: "Генеральная уборка в Белграде — от 9 800 RSD | LumaClean",
      description: "Генеральная уборка квартир в Белграде: кухня, ванная, двери, плинтусы и сложные зоны. Стоимость от 9 800 RSD.",
      ...
      faq: [
        ...
        {q: "Сколько стоит генеральная уборка?", a: "Цена начинается от 9 800 RSD и зависит от площади, состояния квартиры и выбранных дополнительных работ."},
        {q: "Убираете после ремонта?", a: "Нет. Строительную пыль, следы краски, клея и другие последствия ремонта мы не берём в работу."},
        {q: "Можно добавить духовку и холодильник?", a: "Да. Мойка внутри духовки стоит 1 200 RSD, холодильника — 1 000 RSD."},
      ],
    ...
    move: {
      ...
      faq: [
        ...
        {q: "Вы моете шкафы внутри?", a: "Да, это можно добавить в расчёт. Внутренняя мойка шкафов стоит от 1 000 RSD за выбранный объём."},
        ...
        {q: "Сколько стоит уборка перед въездом?", a: "Стоимость начинается от 10 800 RSD. Финальный ориентир зависит от площади и списка внутренних зон."},
      ],
    ...
    airbnb: {
      ...
      faq: [
        ...
        {q: "Меняете постельное бельё?", a: "Да, если чистый комплект подготовлен в апартаменте. Стоимость смены — 800 RSD."},
  ...
  sr: {
    regular: {
      ...
      title: "Čišćenje stanova Beograd — cena od 4.100 RSD | LumaClean",
      description: "Održavajuće čišćenje stanova u svim delovima Beograda: sobe, kuhinja, kupatilo i podovi. Cena od 4.100 RSD.",
      ...
      faq: [
        {q: "Koliko košta čišćenje stana u Beogradu?", a: "Održavajuće čišćenje počinje od 4.100 RSD. Tačan okvir zavisi od kvadrature, stanja i dodatnih radova."},
        {q: "Mogu li da zakažem čišćenje istog dana?", a: "Da, ako postoji slobodan termin. Hitni dolazak istog dana uvećava cenu za 20%."},
        {q: "Da li su prozori uključeni?", a: "Prozori se dodaju posebno: standardni je 950 RSD, a veliki ili panoramski od 1.300 RSD."},
    ...
    deep: {
      ...
      title: "Generalno čišćenje Beograd — od 9.800 RSD | LumaClean",
      description: "Generalno čišćenje stanova u Beogradu: kuhinja, kupatilo, vrata, lajsne i zahtevne zone. Cena od 9.800 RSD.",
      ...
      faq: [
        ...
        {q: "Koliko košta generalno čišćenje?", a: "Cena počinje od 9.800 RSD i zavisi od kvadrature, stanja stana i dodatnih radova."},
        {q: "Da li čistite nakon renoviranja?", a: "Ne. Građevinska prašina, boja, lepak i ostaci materijala nisu deo naših usluga."},
        {q: "Mogu li da dodam rernu i frižider?", a: "Da. Rerna iznutra je 1.200 RSD, a frižider iznutra 1.000 RSD."},
      ],
      image: "/media/material-chrome.webp",
    ...
    move: {
      ...
      faq: [
        ...
        {q: "Da li čistite ormariće iznutra?", a: "Da, to možete dodati obračunu. Cena počinje od 1.000 RSD za dogovoreni obim."},
        ...
        {q: "Koliko košta čišćenje pre useljenja?", a: "Cena počinje od 10.800 RSD i zavisi od kvadrature i spiska unutrašnjih zona."},
      ],
      image: "/media/kitchen-clean.webp",
    ...
    airbnb: {
      ...
      faq: [
        ...
        {q: "Da li menjate posteljinu?", a: "Da, ako je čist komplet pripremljen u apartmanu. Cena promene je 800 RSD."},
  ...
  en: {
    regular: {
      ...
      title: "Apartment Cleaning Belgrade — from 4,100 RSD | LumaClean",
      description: "Regular apartment cleaning across Belgrade: rooms, kitchen, bathroom and floors. Prices from 4,100 RSD with an upfront estimate.",
      ...
      faq: [
        {q: "How much does apartment cleaning cost in Belgrade?", a: "Regular cleaning starts at 4,100 RSD. The exact guide depends on floor area, condition and selected extras."},
        {q: "Can I book a same-day clean?", a: "Yes, when a slot is available. An urgent same-day visit adds 20% to the price."},
        {q: "Are windows included?", a: "Windows are added separately: 950 RSD for a standard window and from 1,300 RSD for a large or panoramic one."},
    ...
    deep: {
      slug: "deep-cleaning",
      title: "Deep Cleaning Belgrade — from 9,800 RSD | LumaClean",
      description: "Deep apartment cleaning in Belgrade covering kitchen, bathroom, doors, skirting boards and difficult zones. From 9,800 RSD.",
      ...
      faq: [
        ...
        {q: "How much does deep cleaning cost?", a: "Prices start at 9,800 RSD and depend on area, apartment condition and selected extras."},
        ...
        {q: "Can I add the oven and fridge?", a: "Yes. Oven interior cleaning is 1,200 RSD and fridge interior cleaning is 1,000 RSD."},
      ],
      image: "/media/material-chrome.webp",
    ...
    move: {
      ...
      faq: [
        ...
        {q: "Do you clean inside cabinets?", a: "Yes, as an extra. Cabinet interior cleaning starts at 1,000 RSD for the agreed scope."},
        ...
        {q: "How much does move-in cleaning cost?", a: "Prices start at 10,800 RSD and depend on the floor area and list of interior zones."},
      ],
      image: "/media/kitchen-clean.webp",
    ...
    airbnb: {
      ...
      faq: [
        ...
        {q: "Do you change bed linen?", a: "Yes, when a clean set is ready in the apartment. Linen change costs 800 RSD."},
