...
const ru: SiteContent = {
  ...
  pricing: {eyebrow: "Прозрачные цены", title: "Понятно ещё до заявки", body: "Стоимость зависит от площади и состояния. В таблице — ориентиры для квартиры без экстремальных загрязнений.", area: ["до 40 м²", "41–60 м²", "61–80 м²", "81–99 м²", "от 100 м²"], from: "от", note: "Минимальный заказ — 4 000 RSD. Окна, техника внутри и сильные загрязнения считаются отдельно.", serviceNames: {regular: "Поддерживающая", deep: "Генеральная", move: "Въезд / выезд", airbnb: "Airbnb / аренда", office: "Офис"}},
  ...
  faq: {eyebrow: "FAQ", title: "Коротко о важном", items: [{q: "Можно заказать уборку сегодня?", a: "Да, если есть свободное окно. Срочный выезд в день обращения добавляет 20% к стоимости."}, {q: "Нужно ли покупать средства?", a: "Нет. Мы можем приехать со своими средствами или использовать ваши — как вам удобнее."}, {q: "Цена в калькуляторе окончательная?", a: "Это предварительный ориентир. Финальную цену подтверждаем после описания состояния квартиры или фотографий."}, {q: "Вы моете окна?", a: "Да. Стандартное окно — 900 RSD, большое или панорамное — от 1 200 RSD."}, {q: "Как оплатить?", a: "Оплата наличными после выполнения уборки. Предоплата не требуется."}]},
